      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method">
               ...
               <option value="credit card">Connect IPS</option>
         ...
         <div class="inputBox">
            <span>city :</span>
            <input type="text" name="city" required placeholder="e.g. Biratnagar">
         </div>
         <div class="inputBox">
            <span>state :</span>
            <input type="text" name="state" required placeholder="e.g. Koshi">
         </div>
         <div class="inputBox">
            <span>country :</span>
